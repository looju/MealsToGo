  ...
  const RestaurantName = () => {
    return (
      <View style={{ alignItems:"center", justifyContent:"center", height:50}}>
        <Text  style={{color:"#fff", fontFamily:"Tangerine_400Regular", fontSize:30}}>{restaurant.name}</Text>
      </View>
    );
  };
      ...
      <List.Section style={{ backgroundColor: "#000", height: 300 }}>
        ...
        >
          ...
          <List.Item
            titleStyle={{ color: "#fff" }}
            title="Oats"
            left={(props) => <List.Icon {...props} icon="bowl" color="#fff" />}
          />
        </List.Accordion>
        ...
        >
          <List.Item
            titleStyle={{ color: "#fff" }}
            title="Rice"
            left={(props) => <List.Icon {...props} icon="rice" color="#fff" />}
          />
          <List.Item
            titleStyle={{ color: "#fff" }}
            title="Cookie"
